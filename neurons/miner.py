...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        chunk_scorer = "gen7heur7"  # hardcoded for gen7heur7 release
        ...
        bt.logging.info("[init] POKER44_CHUNK_SCORER=gen7heur7 (hardcoded for gen7heur7 release)")
        bt.logging.info(
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            defaults={
                "model_name": "poker44_gen7heur7",
                "model_version": "7.5",
                "framework": "python-heuristic",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-gen7heur7",
                "repo_commit": _git_commit,
                "notes": "Gen7heur5 trained on benchmark data from the all available benchmark days.",
                "open_source": True,
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        # gen7heur7 scorer bypasses per-hand ML models entirely
        chunk_scorer = "gen7heur7"  # hardcoded for gen7heur7 release

        if chunk_scorer == "gen7heur7":
            for index, (chunk, mode) in enumerate(zip(chunks, chunk_modes)):
                if mode == "legacy":
                    score = score_chunk_legacy(chunk)
                    route = "legacy_payload_heuristics"
                else:
                    score, route = score_chunk_gen7heur7(chunk)
                scores.append(score)
